...
const Cart = (props) => {
    ...
    const removeItem = productId => { 
        ...
        .then(res => {
            authContent.notify('Selected Cart Item is deleted', 'success');
    ...
    const addOrder =  () => { 
        ...
        console.log("add Order ", state.cartItems);

        axios.post("http://localhost:8080/user/addorder", state.cartItems)
        .then(res => {
            if(res) {
